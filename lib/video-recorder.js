...
var VideoRecorder =
  ...
  (function (_Component) {
    ...
    function VideoRecorder (props) {
      ...
      _this.handleCapture = _this.handleCapture.bind(
        _assertThisInitialized(_this)
      )
      _this.handleCloseCapture = _this.handleCloseCapture.bind(
        _assertThisInitialized(_this)
      )
    ...
    _createClass(VideoRecorder, [
      ...
      },
      {
        ...
        value: function handleCapture () {
          ...
          ;(0, _getVideoInfo.captureThumb)(this.replayVideo).then(function (
            thumbnail
          ) {
            _this7.props.onCaptureThumbnail(thumbnail)
          })
        }
      },
      {
        key: 'handleCloseCapture',
        value: function handleCloseCapture () {
      ...
      },
      {
        ...
        value: function render () {
          ...
          var _this$props2 = this.props,
            ...
            isCreatingThumbnail = _this$props2.isCreatingThumbnail
          return _react.default.createElement(
            Wrapper,
            null,
